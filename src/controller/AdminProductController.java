...
public class AdminProductController {
					...
					public void handle(ActionEvent event) {
						...
						if (alert.getResult() == ButtonType.YES) {
							...
							try {
								...
								// update table data
								new DBInitialize().DBInitialize();
								String queryupdatetable = "EXEC GetAllProducts";
	...
	void onBtUpdateAction(ActionEvent event)
		...
		if (tf_barcode.getText().toString().equals("") || tf_name.getText().toString().equals("")
			...
			String query = "EXEC UpdateProductItem '" + name + "', " + categoryid + ", '" + dateadded + "', '" + expireddate + "', " + price + ", " + supplierid + ", " + stockamount + ", '" + barcode + "'";
	...
	void onbtAddAction(ActionEvent event)
		...
		if (tf_barcode.getText().toString().equals("") || tf_name.getText().toString().equals("")
			...
			String query = "EXEC InsertProductItem '" + name + "', " + categoryid + ", '" + dateadded + "', '" + expireddate + "', " + price + ", '" + barcode + "', " + supplierid + ", " + stockamount;
	...
	void onbtNewAction(ActionEvent event)
		...
		String query = "EXEC GetLatestProductBarcode";
